 ...
 * Estende o modelo base de notificação para incluir o ID da medalha do usuário e a foto da conquista.
 *
 * Propriedades:
 * - userMedalId: Identificador da medalha do usuário associada à notificação.
